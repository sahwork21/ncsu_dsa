...
public class EdgeListGraphTest {
	/**An undirected graph for testing*/
    private Graph<String, Integer> undirectedGraph;
    /**A directed graph for testing*/
    ...
    public void testOutgoingEdges() {
        ...
        assertEquals(e10, directedGraph.outgoingEdges(v4).iterator().next());
        assertEquals(e11, directedGraph.outgoingEdges(v5).iterator().next());
    ...
    public void testIncomingEdges() {
        ...
        assertEquals(e11, directedGraph.incomingEdges(v6).iterator().next());
    ...
    public void testInsertVertex() {
        ...
        undirectedGraph.insertEdge(v1, v2, 5);
        assertEquals(5, undirectedGraph.getEdge(v1, v2).getElement().intValue());
