...
public class BinarySearchTreeMap<K extends Comparable<K>, V> extends AbstractOrderedMap<K, V> {
     ...
     * @param compare the way that entry keys will be compared for sorted order
     */
    ...
    protected static class BalanceableBinaryTree<K, V> extends LinkedBinaryTree<Entry<K, V>> {
        ...
        public void rotate(Position<Entry<K, V>> p) {
            ...
            if(grandParent == null) {
            	//Rotate the child x to be the root
            	setRoot(node);
            	node.setParent(null);
            } else {
...
//            BinaryTreeNode<Entry<K, V>> grandParent = parent.getParent();
        ...
        protected static class BSTNode<E> extends BinaryTreeNode<E> {
        	/**Some BinarySearchTrees have properties like height or color they must acccount for*/
    ...
    /////////////////////////////////////////////////////////////////////////////
    /**
     * Delegates root method to binary tree
     * @return tree root
     */
    ...
    /**
     * Delegates the parent method to the binary tree
     * @param p the position that we want its parent of
     ...
     * @param p the node checked in the tree
     * @return true if the node is internal or false if it's a leaf
     */
    public boolean isInternal(Position<Entry<K, V>> p) {
        return tree.isInternal(p);
    }
    /**
     * Sets the entry at the node to the input entry
     * @param p the node being changed
     * @param entry the new entry at p
     * @return the entry previously stored by p
     */
     ...
     * @param p the node being checked for a leaf
    ...
    /**
     * Checks if a node is the Tree's root
     * @param p the node being checked
     * @return true if p is the root false if not
     */
    public boolean isRoot(Position<Entry<K, V>> p) {
        return tree.isRoot(p);
    }
    /**
     * Gets what the left child is of p
     * @param p the node being accessed for its left child
    ...
    /**
     * Gets what the right child is of p
     * @param p the node being accessed for its right child
    ...
    /**
     * Gets what the sibling of p is
     * @param p the node being accessed for its sibling
     * @return the sibling node of p
     */
