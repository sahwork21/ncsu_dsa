...
public class AdjacencyListGraph<V, E> extends AbstractGraph<V, E> {
	/**The list of vertices that point to other vertices*/
    ...
    public void removeVertex(Vertex<V> vertex) {
        ...
        //Remove the all the occurrences of outgoing and incoming edges in every vertex
        //Have to remove the edges from the vertex's edge list on the other side of the edge
        //Then remove the vertex
        //Only need to do this once if it's undirected as the second for loop will get skipped
        ...
        for(Edge<E> e : v.getIncoming()) {
        	...
        	//Remove the edge from the other vertex. Outgoers
        	
        	
        	validate(edge.getEndpoints()[0]).getOutgoing().remove(edge.getOutgoingListPosition());
        ...
        if(isDirected()) {
        	for(Edge<E> e : v.getOutgoing()) {
        		...
        		validate(edge.getEndpoints()[1]).getIncoming().remove(edge.getIncomingListPosition());
    ...
    public void removeEdge(Edge<E> edge) {
        ...
        //Take the edge out of each of the lists
     ...
     * 
     * @param v the vertex being checked for an instance of ALVertex
     ...
     * 
     * @param e the edge being checked for an instance of ALEdge
