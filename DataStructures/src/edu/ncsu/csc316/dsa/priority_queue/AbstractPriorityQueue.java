...
public abstract class AbstractPriorityQueue<K extends Comparable<K>, V> implements PriorityQueue<K, V> {
	/**The object that will be used to compare elements*/
    ...
    public class NaturalOrder implements Comparator<K> {
    	/**
    	 * Natural Order uses the Natural ordering when comparing methods.
    	 * @param first the first object being compared
    	 * @param second the second object being compared
    	 * @return -1 if first goes first, 1 if second goes first, 0 if they are equal
    	 */
    ...
    public static class PQEntry<K, V> implements Entry<K, V> {
    	/**The key for accessing an Entry*/
        private K key;
        /**The value contained by an Entry*/
        private V value;
     ...
     * @return the PriorityQueue Entry object
     */
